...
description: "Minimalist kaomoji for Nanoo Labs documentation."
date: "2026-05-15"
...
Consume `kaomoji.json` from any language, its the single source of truth. The `index.ts` wrapper is optional.
